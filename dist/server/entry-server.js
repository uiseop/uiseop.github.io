...
const Categories = ({
  ...
  return /* @__PURE__ */ jsx(Wrapper$b, { children: categories2.map((category) => {
...
const Header = ({
  ...
  return /* @__PURE__ */ jsxs(Wrapper$8, { children: [
    ...
    /* @__PURE__ */ jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsx(Categories, { categories: categories2, withLink: true })
    ] })
  ] });
};
...
const Navigationbar = ({
  ...
  return /* @__PURE__ */ jsxs(Navigation$1, { children: [
    ...
    categories2.map((category) => /* @__PURE__ */ jsx(StyledLink$1, { to: `/posts/${category}`, children: /* @__PURE__ */ jsx(CustomButton, { children: category.toUpperCase() }) }, category))
  ] });
};
...
const PostList = ({
  ...
  const filteredFiles = files2.filter(({
    file
  }) => {
    if (!category)
      return true;
...
const ThemeProvider = ({
  ...
  useEffect(() => {
    document.body.dataset.theme = theme2;
  }, [theme2]);
  const value = useMemo(() => ({
    theme: theme2,
    setTheme
...
const files = [headless, delpoy].sort((a, b) => {
  const {
    data: {
      date: aDate
    }
